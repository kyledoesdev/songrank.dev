...
return [
    ...
    */
    ...
    /*
     * The events here are what `php artisan cashier:webhook` subscribes the
     * Stripe endpoint to. Cashier's DEFAULT_EVENTS are all subscription-shaped
     * and this application sells a one-off licence, so none of them apply —
     * leaving them in place would create an endpoint that never delivers
     * `checkout.session.completed` and silently stops every purchase from
     * fulfilling. StripeWebhookEvent is the single list of what we handle.
     */
    'webhook' => [
        'secret' => env('STRIPE_WEBHOOK_SECRET'),
        'tolerance' => env('STRIPE_WEBHOOK_TOLERANCE', 300),
        'events' => array_column(StripeWebhookEvent::cases(), 'value'),
    ],
